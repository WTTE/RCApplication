			...
			return {
				coupon:[{
					list: [{
						...
						seller_name: "艺栈特色度假酒店",
						end_time: "2020-12-23 00:00:20",
						state: "1"
					},
					{
						url: "/pages/brand/index/id/1",
...
.other_type {
	...
	.text { width:91%; border-top:1px solid #eeeeee; display:block; text-align:center; position:relative; }
